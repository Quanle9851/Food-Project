    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(userID.length()<2 || userID.length()>10){
                userError.setUserIDError("length of userID must be in 2-10");
                checkValidation = false;
            }
            ...
            if(!password.equals(confirm)){
                userError.setConfirmError("2 password is not same!");
                checkValidation = false;
            }
            if(checkValidation){
                UserDTO user = new UserDTO(userID, fullName, password, "user02", "", "", "", "");
